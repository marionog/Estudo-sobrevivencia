...
## ANÁLISE COM FOCO NA VARIÁVEL RENDA (MÉDIA DO SETOR CENSITÁRIO, EM SALÁRIOS MÍNIMOS)

# Relação entre renda e faixa etária
...
# Relação entre renda e renda raca/cor
...
# Relação entre renda e natureza do serviço
...
# Relação entre renda e atraso no início do tratamento
...
# Relação entre renda e estadiamento do tumor
...
# Relação entre renda e óbito em 10 anos
...
## Teste Log-rank (argumento rho=0 é o default, não precisa usar)
